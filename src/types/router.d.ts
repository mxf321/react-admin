...
import type { RouteComponent, RouteLocationNormalized } from 'react-router-dom'
...
declare global {
   ...
   */
  interface IRouteChildrenConfigsTable {
    /** 子路由地址 `必填` */
    path: string
  ...
  interface IRouteConfigsTable {
    ...
    params?: {}
    /** 子路由配置项 */
    children?: Array<IRouteConfigsTable>
  }
}

declare module 'react-router' {
  interface IRouteMeta extends CustomizeRouteMeta {}
}
